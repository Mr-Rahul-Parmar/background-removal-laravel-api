...
Download model from this link and move in to
Image-Background-Remover-Python/saved_models/u2net/u2net.pth 

u2net.pth => https://drive.google.com/uc?id=1ao1ovG1Qtx4b7EoskHXmi2E9rp5CHLcZ

Please Install Python packages for Image-Background-Remover-Python
